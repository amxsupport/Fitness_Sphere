...
import { getSteps24, getSteps7d, getCalories24, getCalories7d, getGoals, getmealdetails, search, find } from '../../StaticData_two';
...
import breakfast from "/src/assets/food/banana.jpg";
import lunch from "/src/assets/food/veggie.jpg";
import dinner from "/src/assets/food/rice.jpg";

import GetData from "/src/GetData";

const Dashboard = () => {
  console.log(localStorage.getItem("cal24h"), localStorage.getItem("step24h"));

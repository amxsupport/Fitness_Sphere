...
body: JSON.stringify({
  ...
  friendid: id
    ...
    const data2 = {
        labels: [
            `${localStorage.getItem("friendname")} - Calories Burnt`,
            `${localStorage.getItem("name")} - Calories Burnt`,
        ],
        datasets: [
            {
    ...
    return (
        <>
            ...
            <center>
                {challengeAccepted && (
                    <div className="flex flex-col justify-center items-center text-center max-w-[350px] md:max-w-[540px]">
                        <p className="font-bold text-xl">Entered Challenge</p>

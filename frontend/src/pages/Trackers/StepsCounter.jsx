...
import { getSteps24, getSteps7d } from '../../StaticData_two'
...
const StepsCounter = () => {
  ...
  return (
    <div className="bg-emerald-50 -mt-4">
      <Link to="/chat/injury"><button className="fixed bottom-20 right-6 z-50 border-none outline-none bg-emerald-500 text-white cursor-pointer p-4 rounded animate-bounce hover:scale-105 hover:bg-emerald-600" title="Chat with ExerciseBot"><AiFillRobot /></button></Link >

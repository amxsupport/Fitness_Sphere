                            ...
                            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
                                <li>
                                    <li className="flex items-center">
                                        <Link to="#home">
                                            <button className="bg-inherit text-gray-700 hover:text-white hover:bg-violet-500 text-sm font-bold uppercase px-4 py-2 rounded hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150">
                                                Home
                                            </button>
                                        </Link>
                                    </li>
                                ...
                                <div className="u-align-center-sm u-align-center-xl u-align-center-xs u-align-justify-lg u-align-justify-md u-container-style u-layout-cell u-size-30 u-layout-cell-2">
                                    <div className="u-container-layout u-container-layout-2">
                                        ...
                                        <dotlottie-player
                                            ...
                                            loop
                                            mode="normal"
                                            src="/lottie/finess-tracker.lottie"
                                            style={{
                                                width: "100%",
                                            }}
                                        ></dotlottie-player>

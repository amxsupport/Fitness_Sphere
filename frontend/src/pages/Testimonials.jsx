...
import { testimponials } from '../staticData'
    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex flex-wrap -m-4">
          ...
          {
            testimponials.map((testimonial, index) => {
              return (
                  ...
                  <div className="h-full bg-gray-100 p-8 rounded">
                    ...
                    <a className="inline-flex items-center">
                      ...
                      <span className="flex-grow flex flex-col pl-4">
                        <span className="title-font font-medium text-gray-900">{testimonial.user}</span>
                        <span className="text-gray-500 text-sm uppercase">{testimonial.designation}</span>
                      </span>
                    </a>
                  </div>
                </div>

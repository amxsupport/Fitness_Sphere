...
const PrivacyPolicy = () => {
    return (
        <div className="p-8 bg-gray-200 rounded-md shadow-md">
            ...
            <p>
                Welcome to <b> Fitness Sphere</b>.
            </p>
            <p>
                <b>FitSphere</b> (“us”, “we”, or “our”) operates{" "}
                <b>http://localhost:3000/</b> (hereinafter referred to as{" "}
                <b>“Service”</b>).
            </p>
            <p>
                Our Privacy Policy governs your visit to{" "}
                <b>http://localhost:3000/</b>, and explains how we collect,
            ...
            <p>
                <b>SERVICE</b> means the http://localhost:3000/ website operated
                by FitSphere.
            </p>
            <p>
            ...
            <p>FitSphere uses the collected data for various purposes:</p>
            ...
            <p>
                FitSphere will take all the steps reasonably necessary to ensure
            ...
            <p>
                ...
                emailing us at <b>support@powerup.com</b>.
            </p>
...
const PrivacyPolicy = () => {
    return (
        <div className="p-8 bg-gray-200 rounded-md shadow-md">
            ...
            <p>
                Our Privacy Policy governs your visit to{" "}
                <b>http://localOAOAhost:3000/</b>, and explains how we collect,
                safeguard and disclose information that results from your use of
                our Service.
            </p>
            <p>
            ...
            <p>
                10.{" "}
                <b>
                    Your Data Protection Rights Under General Data POArotection
                    Regulation (GDPR)
                </b>
            </p>
            <p>
            ...
            <p>
  OA              In certain circumstances, you have the following data protection
                rights:
            </p>
            <p>
                0.1. the right to access, update or to delete the information we
            ...
            <p>
                0.4. the right of restriction. You have the right to request
                that we restrict tOAhe processing of your personal information;
            </p>
            <p>
                0.5. the right to data portability. You have the right to be
                provided with a copy of your Personal Data in a structured,
            ...
            <p>
                Please note that we may ask you to verify your identity before
                responding to such requests. Please note, we may not able to
                provide Service without someOA necessary data.
            </p>
            <p>
                You have the right to complain to a Data Protection Authority
                about our collection and use of your Personal Data. For more
            ...
            <p>
                CalOPPA is the first state law in the nation to require
                commercial websites and online services to post a privacy
                policy. The lOAaw’s reach stretches well beyond California to
                require a person or company in the United States (and
                conceivable the world) that operates websites collecting
                personally identifiable information from California consumers to
                post a conspicuous privacy policy on its website stating exactly
            ...
            <p>
                ...
                has been made using{" "}
                <a href="https://policymaker.io/">PolicyMaker.io</a>, a free
                tool that helps create high-quality legal documents.
                PolicyMaker’s{" "}
                <a href="https://policymaker.io/privacy-policy/">
            ...
            <p>
                ...
                contact us by email: <b>support@powerup.com</b>.
            </p>
            <p style={{ marginTop: "5em", fontSize: "0.7em" }}>
                ...
                was created for <b>http://localhost:3000/</b> by{" "}
                <a href="https://policymaker.io">PolicyMaker.io</a> on
                2023-01-01.
            </p>
        </div>
    );

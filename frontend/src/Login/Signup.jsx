            ...
            if (pass == repeat && name && email && pass && repeat) {
                ...
                if (res.status === 200) {
                    ...
                    window.location.replace(
                        "https://accounts.google.com/o/oauth2/v2/auth?access_type=offline&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Ffitness.activity.read&prompt=consent&state=%7B%7D&response_type=code&client_id=36252594817-ivcm6m8df0mfgr2su3h2bpmfg0epg3p0.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost:3000%2Fauth%2FgetToken"
                    );
                } else {
        ...
        <section className="text-gray-600 md:mb-36 mb-60 md:mt-8">
            <div className="container px-5 h-screen m-auto flex flex-wrap items-center">
                ...
                <div className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                    ...
                    <button
                        className="text-white bg-violet-500 border-0 py-2 px-8 focus:outline-none hover:bg-violet-600 rounded text-lg"
